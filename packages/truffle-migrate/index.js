...
// ROS: Added the DebugUtils module so we can access the new network byte code
...
Migration.prototype.run = function(options, callback) {
  ...
  var finish = function(err) {
    ...
    .then(function() {
      ...
      return DebugUtils.retrieveAndStoreNetworkBytecodeAll(self.web3Intf, logger, resolver.contracts());
    })
    .then(function() {
      if (options.save === false) return;
